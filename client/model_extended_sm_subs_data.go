...
type _ExtendedSmSubsData ExtendedSmSubsData
...
func (o *ExtendedSmSubsData) UnmarshalJSON(bytes []byte) (err error) {
	...
	varExtendedSmSubsData := _ExtendedSmSubsData{}

	err = json.Unmarshal(bytes, &varExtendedSmSubsData)

	if err != nil {
		return err
	}

	*o = ExtendedSmSubsData(varExtendedSmSubsData)
